              ...
              <form onSubmit={handleEdit} className={Style.signInHtm}>
                ...
                <div className={Style.group}>
                  ...
                  <input
                    ...
                    checked={hobbies.includes("E-sports") ? true : false}
                  />
                  <label htmlFor="E-sports" className="ps-2 pe-10">
                  E-sports
                  </label>
                  <input
                    id="cycling"
                ...
                <div className={Style.group}>
                  ...
                  <select value={input.corse} id="corse" className={Style.checkLabel} onChange={handleChange} name="corse">
                    ...
                    <option value="React.js" className={Style.checkInput}>
                      React.js
                    </option>
                    <option value="Flutter" className={Style.checkInput}>
                      Flutter
                    </option>
                    <option value="JavaScript" className={Style.checkInput}>
                      JavaScript
                    </option>
                  </select>
